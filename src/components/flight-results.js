...
export function FlightResults({ flights, isLoading, searchParams, onFlightSelect }) {
    ...
    const sortedFlights = useMemo(() => {
        ...
        const sorted = [...flights].sort((a, b) => {
            switch (sortBy) {
                ...
                case 'duration':
                    // Parse duration strings like "3h 30m" - handle null/undefined values
                    const getDurationMinutes = (duration) => {
                        if (!duration)
                            return 999999; // Put flights without duration at the end
                ...
                case 'departure':
                    // Handle null/undefined departure times
                    if (!a.departureTime && !b.departureTime)
                        return 0;
                    if (!a.departureTime)
                        return 1; // Put flights without departure time at the end
                    if (!b.departureTime)
                        return -1;
                    // Try to parse the time for comparison
    ...
    const formatDuration = (duration) => {
        ...
        // If we can't parse it, return a helpful message
    ...
    return (_jsx("div", { className: "space-luxury", children: _jsxs("div", { className: "max-w-6xl mx-auto", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, className: "flex flex-col md:flex-row justify-between items-start md:items-center mb-8", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-3xl font-bold text-white mb-2", style: { fontFamily: 'var(--font-luxury)' }, children: "Available Flights" }), _jsxs("p", { className: "text-gray-300", children: [flights.length, " premium options from ", searchParams.origin, " to ", searchParams.destination] })] }), _jsx("div", { className: "flex gap-2 mt-4 md:mt-0", children: [
                                ...
                                { key: 'duration', label: 'Shortest', icon: 'lucide:clock' },
                                { key: 'departure', label: 'Earliest', icon: 'lucide:sunrise' }
                ...
                `, onClick: () => {
                  ...
                  `, style: {
                                    ...
                                    }, children: _jsxs(CardBody, { className: "p-6", children: [_jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-6 items-center", children: [_jsxs("div", { className: "lg:col-span-3", children: [_jsxs("div", { className: "flex items-center gap-3 mb-2", children: [_jsx("div", { className: "glass-card p-2 rounded-lg w-14 h-14 bg-white/95 border border-white/20", children: _jsx(AirlineLogo, { airline: flight.airline }) }), _jsxs("div", { children: [_jsx("div", { className: "font-semibold text-white", children: flight.airline }), _jsx("div", { className: "text-sm text-gray-400", children: flight.flightNumber })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Icon, { icon: getCabinIcon(flight.cabinClass), className: `text-sm ${getCabinColor(flight.cabinClass)}` }), _jsx("span", { className: "text-sm text-gray-300", children: flight.cabinClass })] })] }), _jsxs("div", { className: "lg:col-span-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: `text-xl font-bold ${flight.departureTime ? 'text-white' : 'text-gray-500'}`, children: formatTime(flight.departureTime) }), _jsx("div", { className: "text-sm text-gray-400", children: flight.origin })] }), _jsxs("div", { className: "flex-1 mx-4", children: [_jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-0 flex items-center", children: _jsx("div", { className: "w-full border-t border-dashed border-gray-400" }) }), _jsx("div", { className: "relative flex justify-center", children: _jsx("div", { className: "glass-card px-3 py-1 rounded-full", children: _jsx("span", { className: `text-xs ${flight.duration ? 'text-gray-300' : 'text-gray-500'}`, children: formatDuration(flight.duration) }) }) })] }), _jsx("div", { className: "text-center mt-2", children: flight.layovers && flight.layovers.length > 0 ? (_jsxs("span", { className: "text-xs text-yellow-400", children: [flight.layovers.length, " stop", flight.layovers.length > 1 ? 's' : ''] })) : flight.departureTime && flight.arrivalTime ? (_jsx("span", { className: "text-xs text-green-400", children: "Non-stop" })) : (_jsx("span", { className: "text-xs text-gray-500", children: "Route details TBD" })) })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: `text-xl font-bold ${flight.arrivalTime ? 'text-white' : 'text-gray-500'}`, children: formatTime(flight.arrivalTime) }), _jsx("div", { className: "text-sm text-gray-400", children: flight.destination })] })] }), (!flight.departureTime || !flight.arrivalTime || !flight.duration) && (_jsx("div", { className: "mt-2 text-center", children: _jsxs("div", { className: "inline-flex items-center gap-1 px-2 py-1 rounded-full bg-blue-500/10 border border-blue-500/20", children: [_jsx(Icon, { icon: "lucide:info", className: "text-xs text-blue-400" }), _jsx("span", { className: "text-xs text-blue-400", children: "Schedule details available after booking" })] }) }))] }), _jsx("div", { className: "lg:col-span-3", children: _jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "text-2xl font-bold text-gradient-gold", children: [flight.points?.toLocaleString() || 'N/A', " pts"] }), _jsxs("div", { className: "text-sm text-gray-400", children: ["+ $", flight.cash?.toLocaleString() || '0', " taxes"] }), _jsx("div", { className: "mt-2", children: _jsxs(Chip, { size: "sm", className: `${flight.seatsAvailable > 4
                                                                            ? 'bg-green-500/20 text-green-400'
                                                                            : flight.seatsAvailable > 1
                                                                                ? 'bg-yellow-500/20 text-yellow-400'
                                                                                : 'bg-red-500/20 text-red-400'}`, children: [flight.seatsAvailable, " seat", flight.seatsAvailable !== 1 ? 's' : '', " left"] }) })] }) }), _jsx("div", { className: "lg:col-span-2", children: _jsxs(Button, { className: "btn-luxury w-full group-hover:scale-105 transition-transform duration-300", size: "lg", children: [_jsx(Icon, { icon: "lucide:bookmark", className: "mr-2" }), "Select"] }) })] }), selectedFlight === flight.id && (_jsxs(motion.div, { initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: 'auto' }, exit: { opacity: 0, height: 0 }, transition: { duration: 0.3 }, className: "mt-6 pt-6 border-t border-white/10", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-semibold text-white mb-2", children: "Aircraft" }), _jsxs("p", { className: "text-gray-300", children: [flight.airline, " Boeing 777-300ER"] })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-semibold text-white mb-2", children: "Booking Class" }), _jsx("p", { className: "text-gray-300", children: flight.cabinClass })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-semibold text-white mb-2", children: "Last Updated" }), _jsx("p", { className: "text-gray-300", children: flight.lastUpdated ? new Date(flight.lastUpdated).toLocaleDateString() : 'N/A' })] })] }), _jsx("div", { className: "flex justify-end mt-6", children: _jsx(Button, { className: "btn-luxury", size: "lg", endContent: _jsx(Icon, { icon: "lucide:external-link" }), children: "Book Now" }) })] }))] }) }), index === 0 && sortBy === 'points' && (_jsx("div", { className: "absolute -top-3 left-6 z-10", children: _jsx(Chip, { size: "sm", color: "warning", variant: "solid", className: "font-semibold", children: "Best Value" }) }))] }, flight.id))) }) }), _jsx(motion.div, { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.6, delay: 0.5 }, className: "mt-12 text-center", children: _jsxs("div", { className: "card-premium p-8 max-w-2xl mx-auto", children: [_jsx("h3", { className: "text-2xl font-bold text-white mb-4", style: { fontFamily: 'var(--font-luxury)' }, children: "Need Help Booking?" }), _jsx("p", { className: "text-gray-300 mb-6", children: "Our premium travel concierge team is available 24/7 to assist with complex bookings and special requests." }), _jsx(Button, { className: "btn-luxury", size: "lg", endContent: _jsx(Icon, { icon: "lucide:phone" }), children: "Contact Concierge" })] }) })] }) }));
}
