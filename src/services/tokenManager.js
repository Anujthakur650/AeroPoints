...
class TokenManager {
     ...
     */
    static async autoRefreshIfNeeded() {
...
Object.defineProperty(TokenManager, "TOKEN_KEY", {
    ...
    configurable: true,
    writable: true,
    value: 'aeropoints_token'
});
Object.defineProperty(TokenManager, "REFRESH_KEY", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 'aeropoints_refresh'
});
Object.defineProperty(TokenManager, "EXPIRY_KEY", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 'aeropoints_expiry'
});
