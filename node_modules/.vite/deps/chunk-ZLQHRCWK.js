...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react.default)["useSyncExternalStore"] === "function") return (0, import_react.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
function $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a() {
  ...
  let [defaultLocale, setDefaultLocale] = (0, import_react2.useState)($1e5a04cdaf7d1af8$var$currentLocale);
...
var $18f2051aff69b9bf$var$I18nContext = (0, import_react3.default).createContext(null);
function $18f2051aff69b9bf$export$a54013f0d02a8f82(props) {
  let { locale, children } = props;
  let defaultLocale = (0, $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a)();
  let value = (0, import_react3.default).useMemo(() => {
  ...
  return (0, import_react3.default).createElement($18f2051aff69b9bf$var$I18nContext.Provider, {
    value
  }, children);
}
...
function $321bc95feeb923dd$export$ec23bf898b1eed85(strings) {
  ...
  let dictionary = (0, import_react4.useMemo)(() => $321bc95feeb923dd$var$getCachedDictionary(strings), [
    strings
  ]);
  let formatter = (0, import_react4.useMemo)(() => new (0, $972eb555d604f491$export$526ebc05ff964723)(locale, dictionary), [
    locale,
    dictionary
  ]);
  return (0, import_react4.useCallback)((key, variables) => formatter.format(key, variables), [
    formatter
  ]);
}
...
function $33bf17300c498528$export$a2f47a3d2973640(options = {}) {
  let { locale } = (0, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7)();
  return (0, import_react6.useMemo)(() => new Intl.ListFormat(locale, options), [
    locale,
    options
  ]);
}
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
  ...
  let updateValue = (0, import_react10.useCallback)((val) => {
    nextId.current = val;
  }, []);
...
function $ea8dcbcb9ea1b556$export$323e4fc2fa4753fb(props) {
  ...
  let ctx = (0, import_react11.useMemo)(() => ({
    isNative: false,
  ...
  return (0, import_react11.default).createElement($ea8dcbcb9ea1b556$var$RouterContext.Provider, {
    value: ctx
  }, children);
}
...
function $5df64b3807dc15ee$export$d699905dd57c73ca() {
  let isSSR = (0, $b5e257d569688ac6$export$535bd6ca7f90a273)();
  let [size, setSize] = (0, import_react18.useState)(() => isSSR ? {
    width: 0,
    height: 0
...
function $99facab73266f662$export$5add1d006293d136(ref, initialValue, onReset) {
  let resetValue = (0, import_react22.useRef)(initialValue);
...
var $5671b20cf9b562b2$export$9db568f6321ad9dc = "react-aria-update-activedescendant";
...
function $896ba0a80a8f4d36$export$85fd5fdf27bacc79(options) {
  ...
  let { locale } = (0, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7)();
  return (0, import_react26.useMemo)(() => new (0, $fb18d541ea1ad717$export$ad991b66133851cf)(locale, options), [
    locale,
    options
  ]);
}
...
function $a916eb452884faea$export$b7a616150fdb9f44(options = {}) {
  let { locale } = (0, $18f2051aff69b9bf$export$43bb16f9c6d9e3f7)();
  return (0, import_react27.useMemo)(() => new (0, $488c6ddbf4ef74c2$export$cc77c4ff7e8673c5)(locale, options), [
    locale,
    options
  ]);
}
...
function $bb77f239b46e8c72$export$3274cf84b703fff(options) {
  ...
  let startsWith4 = (0, import_react28.useCallback)((string, substring) => {
  ...
  let endsWith = (0, import_react28.useCallback)((string, substring) => {
    if (substring.length === 0) return true;
    string = string.normalize("NFC");
    substring = substring.normalize("NFC");
  ...
  let contains = (0, import_react28.useCallback)((string, substring) => {
    if (substring.length === 0) return true;
    string = string.normalize("NFC");
    substring = substring.normalize("NFC");
    let scan = 0;
...
export {
  ...
  $5671b20cf9b562b2$export$9db568f6321ad9dc,
...
//# sourceMappingURL=chunk-ZLQHRCWK.js.map
